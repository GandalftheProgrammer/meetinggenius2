...
const convertMarkdownToHtml = (md: string): string => {
    ...
    // Wrap loose paragraphs (that are not headers or within lists)
    ...
    // High-quality Document Template for Google Docs conversion (Matching Screenshot 2 aesthetic)
    return `<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <style>
        @page {
            margin: 2.54cm; /* Standard 1-inch margins for print/doc */
        }
        body {
        ...
        .container {
            padding: 40pt; /* Initial padding to simulate the look of a doc page */
        }
        h1 {
            font-size: 20pt;
            font-weight: bold;
...
<body>
    <div class="container">
        ${html}
        <div class="footer">
            Generated by MeetingGenius Cloud.
        </div>
    </div>
</body>
</html>`;
